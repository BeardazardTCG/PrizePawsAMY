...
export const profileDog = {
  ...
  milestones: ["First Entry", "First Rosette", "First Win", "Calendar Finalist", "Top Pup Graduate", "People’s Choice Winner"],
...
export const profileCards = [
  ...
  { name: "Daisy", breed: "Labrador", county: "Norfolk", status: "Rainbow Bridge", profileNumber: "BB-000042", rosetteCount: 6, latestAchievement: "Calendar Pup", memorial: { heading: "In Loving Memory", birthDate: "3 March 2012", passingDate: "18 November 2025", message: "Forever the gentle beach girl who taught her family to notice every small joy.", achievements: ["Calendar Pup", "People’s Choice Winner", "Senior Sweetheart"], photos: ["Beach paws", "Birthday nap", "Rosette day"] } }
];
